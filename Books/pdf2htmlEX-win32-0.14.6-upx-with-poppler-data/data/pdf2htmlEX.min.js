...
*/
    ...
    function toggleOutline() {
        ...
        window.console.log("toggleOutline: " + (sidebar.classList.contains("opened")));
            ...
            window.addEventListener("keydown", function (b) {
                ...
                switch (b.keyCode) {
                    ...
                    case 187:
                        ...
                        (a.rescale(1 / a.config.scale_step, !0), c = !0);
                        break;
                    case 173:
                    case 109: // -
                    case 189:
                        // e && (a.rescale(a.config.scale_step, !0), c = !0);
                        (a.rescale(a.config.scale_step, !0), c = !0);
                        break;
                    case 48: // 0
                        // e && (a.rescale(0, !1), c = !0);
                        (a.rescale(0, !1), c = !0);
                    ...
                    case 103: // g
                    case 71: // G
                        var targetPage = window.prompt("Go to page", a.cur_page_idx+1);
                        // var targetPage = window.prompt("Go to page", "1-" + a.pages.length);
                        a.scroll_to(targetPage-1);
