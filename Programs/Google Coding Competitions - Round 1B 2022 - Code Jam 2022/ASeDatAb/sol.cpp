...
int main()
{
    ...
    while (t--)
    {
        ...
        while (verdict != 0)
        {
            ...
            {
                int guess = uniform_int_distribution<int>(0, 256)(rng);
                while (__builtin_popcount(guess) != 8 - verdict)
                {
                    guess = uniform_int_distribution<int>(0, 255)(rng);
                }
                cout << std::bitset<8>(guess) << endl;
                cin >> verdict;
            }
        }
    }
